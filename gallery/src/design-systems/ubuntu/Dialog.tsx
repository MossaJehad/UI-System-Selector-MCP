  ...
  return (
    <div className="ds-ubuntu">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-ubuntu" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-ubuntu"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-ubuntu"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-ubuntu">
            ...
            <div className="ds-dialog-body-ubuntu">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-ubuntu">
              <button
                type="button"
                className="ds-btn-ubuntu ds-btn-ubuntu-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-ubuntu ds-btn-ubuntu-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
