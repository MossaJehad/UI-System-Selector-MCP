...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-ubuntu" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-ubuntu" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-ubuntu ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-ubuntu ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-ubuntu ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-ubuntu" role="tabpanel">
        {activeTab === 'overview' && (
