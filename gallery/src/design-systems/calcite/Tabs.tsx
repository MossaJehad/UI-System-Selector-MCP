...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-calcite" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-calcite" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-calcite ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-calcite ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-calcite ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-calcite" role="tabpanel">
        {activeTab === 'overview' && (
