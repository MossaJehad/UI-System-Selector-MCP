...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-photon" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-photon" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-photon ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-photon ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-photon ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-photon" role="tabpanel">
        {activeTab === 'overview' && (
