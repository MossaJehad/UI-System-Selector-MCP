...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-mailchimp" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-mailchimp" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-mailchimp ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-mailchimp ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-mailchimp ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-mailchimp" role="tabpanel">
        {activeTab === 'overview' && (
