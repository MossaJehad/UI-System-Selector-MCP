...
export const Pagination: React.FC = () => {
  ...
  return (
    <div className="ds-cloudscape" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <nav className="ds-pagination-cloudscape" aria-label="Pagination Navigation">
        <button
          type="button"
          className="ds-page-btn-cloudscape"
        ...
        {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
          <button
            key={page}
            type="button"
            className={`ds-page-btn-cloudscape ${currentPage === page ? 'active' : ''}`}
