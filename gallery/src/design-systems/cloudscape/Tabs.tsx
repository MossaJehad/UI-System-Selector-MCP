...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-cloudscape" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-cloudscape" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-cloudscape ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-cloudscape ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-cloudscape ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-cloudscape" role="tabpanel">
        {activeTab === 'overview' && (
