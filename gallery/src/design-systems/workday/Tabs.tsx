...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-workday" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-workday" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-workday ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-workday ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-workday ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-workday" role="tabpanel">
        {activeTab === 'overview' && (
