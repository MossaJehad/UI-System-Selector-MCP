...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-xp-css" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-xp-css" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-xp-css ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-xp-css ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-xp-css ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-xp-css" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
