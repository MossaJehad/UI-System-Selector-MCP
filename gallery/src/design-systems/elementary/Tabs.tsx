...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-elementary" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-elementary" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-elementary ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-elementary ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-elementary ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-elementary" role="tabpanel">
        {activeTab === 'overview' && (
