...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-mantine" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-mantine" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-mantine ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-mantine ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-mantine ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-mantine" role="tabpanel">
        {activeTab === 'overview' && (
