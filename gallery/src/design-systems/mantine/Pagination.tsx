...
export const Pagination: React.FC = () => {
  ...
  return (
    <div className="ds-mantine" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <nav className="ds-pagination-mantine" aria-label="Pagination Navigation">
        <button
          type="button"
          className="ds-page-btn-mantine"
        ...
        {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
          <button
            key={page}
            type="button"
            className={`ds-page-btn-mantine ${currentPage === page ? 'active' : ''}`}
