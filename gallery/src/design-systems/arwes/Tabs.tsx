...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-arwes" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-arwes" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-arwes ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-arwes ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-arwes ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-arwes" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
