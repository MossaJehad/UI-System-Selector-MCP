...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-evergreen" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-evergreen" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-evergreen ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-evergreen ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-evergreen ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-evergreen" role="tabpanel">
        {activeTab === 'overview' && (
