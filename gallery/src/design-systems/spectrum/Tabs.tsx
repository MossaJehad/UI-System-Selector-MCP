...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-spectrum" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-spectrum" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-spectrum ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-spectrum ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-spectrum ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-spectrum" role="tabpanel">
        {activeTab === 'overview' && (
