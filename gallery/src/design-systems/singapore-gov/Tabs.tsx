...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-singapore-gov" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-singapore-gov" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-singapore-gov ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-singapore-gov ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-singapore-gov ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-singapore-gov" role="tabpanel">
        {activeTab === 'overview' && (
