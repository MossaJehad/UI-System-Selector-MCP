...
export const Pagination: React.FC = () => {
  ...
  return (
    <div className="ds-siemens-ix" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <nav className="ds-pagination-siemens-ix" aria-label="Pagination Navigation">
        <button
          type="button"
          className="ds-page-btn-siemens-ix"
        ...
        {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
          <button
            key={page}
            type="button"
            className={`ds-page-btn-siemens-ix ${currentPage === page ? 'active' : ''}`}
