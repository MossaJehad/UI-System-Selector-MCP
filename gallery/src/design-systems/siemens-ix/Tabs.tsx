...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-siemens-ix" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-siemens-ix" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-siemens-ix ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-siemens-ix ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-siemens-ix ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-siemens-ix" role="tabpanel">
        {activeTab === 'overview' && (
