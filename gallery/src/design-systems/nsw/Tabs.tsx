...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-nsw" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-nsw" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-nsw ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-nsw ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-nsw ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-nsw" role="tabpanel">
        {activeTab === 'overview' && (
