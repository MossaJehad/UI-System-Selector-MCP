...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-barista" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-barista" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-barista ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-barista ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-barista ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-barista" role="tabpanel">
        {activeTab === 'overview' && (
