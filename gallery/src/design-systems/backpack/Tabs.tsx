...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-backpack" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-backpack" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-backpack ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-backpack ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-backpack ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-backpack" role="tabpanel">
        {activeTab === 'overview' && (
