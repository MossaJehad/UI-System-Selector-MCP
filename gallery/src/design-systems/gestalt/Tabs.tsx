...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-gestalt" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-gestalt" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-gestalt ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-gestalt ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-gestalt ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-gestalt" role="tabpanel">
        {activeTab === 'overview' && (
