  ...
  return (
    <div className="ds-vitamin">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-vitamin" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-vitamin"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-vitamin"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-vitamin">
            ...
            <div className="ds-dialog-body-vitamin">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-vitamin">
              <button
                type="button"
              ...
              <button
                type="button"
                className="ds-btn-vitamin ds-btn-vitamin-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
