...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-vitamin" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-vitamin" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-vitamin ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-vitamin ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-vitamin ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-vitamin" role="tabpanel">
        {activeTab === 'overview' && (
