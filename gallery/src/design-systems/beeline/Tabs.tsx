...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-beeline" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-beeline" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-beeline ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-beeline ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-beeline ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-beeline" role="tabpanel">
        {activeTab === 'overview' && (
