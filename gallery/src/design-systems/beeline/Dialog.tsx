  ...
  return (
    <div className="ds-beeline">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-beeline" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-beeline"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-beeline"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-beeline">
            ...
            <div className="ds-dialog-body-beeline">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-beeline">
              <button
                type="button"
                className="ds-btn-beeline ds-btn-beeline-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-beeline ds-btn-beeline-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
