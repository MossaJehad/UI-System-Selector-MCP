...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-eui" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-eui" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-eui ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-eui ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-eui ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-eui" role="tabpanel">
        {activeTab === 'overview' && (
