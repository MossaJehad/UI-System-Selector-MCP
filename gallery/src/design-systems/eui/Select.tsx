...
export const Select: React.FC = () => {
  ...
  return (
    <div className="ds-eui" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' }}>
      <div>
        <label className="ds-label-eui">Select Region (Interactive)</label>
        <select
          className="ds-select-eui"
          value={selected}
        ...
        <span className="ds-helper-eui">Active choice: <strong>{selected}</strong></span>
      </div>

      <div>
        <label className="ds-label-eui">Selected Tier</label>
        <select className="ds-select-eui" defaultValue="enterprise">
        ...
        <span className="ds-helper-eui">Includes 24/7 SLA & priority routing</span>
      </div>

      <div>
        <label className="ds-label-eui">Error State</label>
        <select className="ds-select-eui error" defaultValue="">
        ...
        <span className="ds-error-text-eui">You must select an isolated VPC</span>
      </div>

      <div>
        <label className="ds-label-eui">Disabled Select</label>
        <select className="ds-select-eui" defaultValue="locked" disabled>
          <option value="locked">Production Environment (Locked)</option>
          <option value="staging">Staging</option>
        </select>
        <span className="ds-helper-eui">Locked by compliance policy</span>
      </div>
    </div>
  );
};
