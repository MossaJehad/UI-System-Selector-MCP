...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-ahoy" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-ahoy" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-ahoy ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-ahoy ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-ahoy ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-ahoy" role="tabpanel">
        {activeTab === 'overview' && (
