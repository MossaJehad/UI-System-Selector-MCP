...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-react95" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-react95" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-react95 ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-react95 ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-react95 ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-react95" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
