...
export const Dialog: React.FC = () => {
  ...
  return (
    <div className="ds-react95" style={{ padding: '8px 0' }}>
      ...
      {isOpen && (
        <div className="ds-dialog-overlay-react95" onClick={() => setIsOpen(false)}>
          <div
            className="ds-dialog-box-react95"
            onClick={e => e.stopPropagation()}
            role="dialog"
            aria-modal="true"
          >
            <div className="ds-dialog-header-react95">
            ...
            <div className="ds-dialog-body-react95">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-react95">
              <button
                type="button"
                className="ds-btn-react95 ds-btn-react95-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-react95 ds-btn-react95-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
