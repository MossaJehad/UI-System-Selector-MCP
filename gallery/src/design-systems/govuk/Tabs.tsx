...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-govuk" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-govuk" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-govuk ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-govuk ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-govuk ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-govuk" role="tabpanel">
        {activeTab === 'overview' && (
