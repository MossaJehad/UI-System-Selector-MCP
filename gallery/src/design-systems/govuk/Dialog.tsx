  ...
  return (
    <div className="ds-govuk">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-govuk" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-govuk"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-govuk"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-govuk">
            ...
            <div className="ds-dialog-body-govuk">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-govuk">
              <button
                type="button"
              ...
              <button
                type="button"
                className="ds-btn-govuk ds-btn-govuk-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
