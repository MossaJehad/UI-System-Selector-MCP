...
export const Toast: React.FC = () => {
  ...
  return (
    <div className="ds-porsche" style={{ padding: '8px 0', minHeight: '80px', position: 'relative' }}>
      ...
      {toastOpen && (
        ...
        >
          <span className="ds-toast-content-porsche">
            ✓ Settings saved successfully. Node #{counter} configuration synchronized.
          </span>
          <button
            type="button"
            className="ds-toast-close-porsche"
