  ...
  return (
    <div className="ds-porsche">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-porsche" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-porsche"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-porsche"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-porsche">
            ...
            <div className="ds-dialog-body-porsche">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-porsche">
              <button
                type="button"
                className="ds-btn-porsche ds-btn-porsche-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-porsche ds-btn-porsche-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
