...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-porsche" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-porsche" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-porsche ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-porsche ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-porsche ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-porsche" role="tabpanel">
        {activeTab === 'overview' && (
