...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-anvil" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-anvil" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-anvil ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-anvil ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-anvil ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-anvil" role="tabpanel">
        {activeTab === 'overview' && (
