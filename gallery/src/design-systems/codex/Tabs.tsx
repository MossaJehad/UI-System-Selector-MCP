...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-codex" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-codex" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-codex ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-codex ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-codex ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-codex" role="tabpanel">
        {activeTab === 'overview' && (
