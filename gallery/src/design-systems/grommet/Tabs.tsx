...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-grommet" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-grommet" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-grommet ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-grommet ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-grommet ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-grommet" role="tabpanel">
        {activeTab === 'overview' && (
