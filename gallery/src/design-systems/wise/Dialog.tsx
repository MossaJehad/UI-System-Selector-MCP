  ...
  return (
    <div className="ds-wise">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-wise" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-wise"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-wise"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-wise">
            ...
            <div className="ds-dialog-body-wise">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-wise">
              <button
                type="button"
                className="ds-btn-wise ds-btn-wise-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-wise ds-btn-wise-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
