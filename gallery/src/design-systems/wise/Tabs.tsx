...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-wise" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-wise" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-wise ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-wise ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-wise ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-wise" role="tabpanel">
        {activeTab === 'overview' && (
