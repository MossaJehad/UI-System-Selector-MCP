...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-wanda" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-wanda" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-wanda ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-wanda ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-wanda ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-wanda" role="tabpanel">
        {activeTab === 'overview' && (
