...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-stacks" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-stacks" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-stacks ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-stacks ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-stacks ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-stacks" role="tabpanel">
        {activeTab === 'overview' && (
