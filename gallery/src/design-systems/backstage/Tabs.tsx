...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-backstage" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-backstage" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-backstage ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-backstage ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-backstage ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-backstage" role="tabpanel">
        {activeTab === 'overview' && (
