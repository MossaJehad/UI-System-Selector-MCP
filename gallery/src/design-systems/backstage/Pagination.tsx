...
export const Pagination: React.FC = () => {
  ...
  return (
    <div className="ds-backstage" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <nav className="ds-pagination-backstage" aria-label="Pagination Navigation">
        <button
          type="button"
          className="ds-page-btn-backstage"
        ...
        {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
          <button
            key={page}
            type="button"
            className={`ds-page-btn-backstage ${currentPage === page ? 'active' : ''}`}
