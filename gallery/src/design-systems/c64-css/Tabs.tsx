...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-c64-css" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-c64-css" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-c64-css ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-c64-css ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-c64-css ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-c64-css" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
