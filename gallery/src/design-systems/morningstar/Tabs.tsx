...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-morningstar" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-morningstar" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-morningstar ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-morningstar ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-morningstar ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-morningstar" role="tabpanel">
        {activeTab === 'overview' && (
