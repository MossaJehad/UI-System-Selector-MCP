...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-orbit" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-orbit" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-orbit ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-orbit ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-orbit ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-orbit" role="tabpanel">
        {activeTab === 'overview' && (
