...
export const Dialog: React.FC = () => {
  ...
  return (
    <div className="ds-hana-ui" style={{ padding: '8px 0' }}>
      ...
      {isOpen && (
        <div className="ds-dialog-overlay-hana-ui" onClick={() => setIsOpen(false)}>
          <div
            className="ds-dialog-box-hana-ui"
            onClick={e => e.stopPropagation()}
            role="dialog"
            aria-modal="true"
          >
            <div className="ds-dialog-header-hana-ui">
            ...
            <div className="ds-dialog-body-hana-ui">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-hana-ui">
              <button
                type="button"
                className="ds-btn-hana-ui ds-btn-hana-ui-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-hana-ui ds-btn-hana-ui-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
