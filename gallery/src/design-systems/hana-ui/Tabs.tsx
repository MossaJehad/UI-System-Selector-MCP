...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-hana-ui" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-hana-ui" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-hana-ui ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-hana-ui ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-hana-ui ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-hana-ui" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
