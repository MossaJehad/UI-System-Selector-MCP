...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-pajamas" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-pajamas" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-pajamas ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-pajamas ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-pajamas ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-pajamas" role="tabpanel">
        {activeTab === 'overview' && (
