...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-quickbooks" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-quickbooks" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-quickbooks ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-quickbooks ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-quickbooks ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-quickbooks" role="tabpanel">
        {activeTab === 'overview' && (
