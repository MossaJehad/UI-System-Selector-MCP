...
export const Dialog: React.FC = () => {
  ...
  return (
    <div className="ds-vengeance-ui" style={{ padding: '8px 0' }}>
      ...
      {isOpen && (
        <div className="ds-dialog-overlay-vengeance-ui" onClick={() => setIsOpen(false)}>
          <div
            className="ds-dialog-box-vengeance-ui"
            onClick={e => e.stopPropagation()}
            role="dialog"
            aria-modal="true"
          >
            <div className="ds-dialog-header-vengeance-ui">
            ...
            <div className="ds-dialog-body-vengeance-ui">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-vengeance-ui">
              <button
                type="button"
                className="ds-btn-vengeance-ui ds-btn-vengeance-ui-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-vengeance-ui ds-btn-vengeance-ui-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
