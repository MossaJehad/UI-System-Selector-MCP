...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-vengeance-ui" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-vengeance-ui" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-vengeance-ui ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-vengeance-ui ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-vengeance-ui ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-vengeance-ui" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
