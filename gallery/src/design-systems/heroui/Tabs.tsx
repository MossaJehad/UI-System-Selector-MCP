...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-heroui" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-heroui" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-heroui ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-heroui ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-heroui ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-heroui" role="tabpanel">
        {activeTab === 'overview' && (
