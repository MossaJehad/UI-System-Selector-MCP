...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-auro" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-auro" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-auro ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-auro ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-auro ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-auro" role="tabpanel">
        {activeTab === 'overview' && (
