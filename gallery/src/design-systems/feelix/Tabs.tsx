...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-feelix" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-feelix" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-feelix ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-feelix ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-feelix ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-feelix" role="tabpanel">
        {activeTab === 'overview' && (
