...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-polaris" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-polaris" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-polaris ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-polaris ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-polaris ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-polaris" role="tabpanel">
        {activeTab === 'overview' && (
