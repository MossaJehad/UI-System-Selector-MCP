...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-leafygreen" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-leafygreen" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-leafygreen ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-leafygreen ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-leafygreen ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-leafygreen" role="tabpanel">
        {activeTab === 'overview' && (
