...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-liquid" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-liquid" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-liquid ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-liquid ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-liquid ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-liquid" role="tabpanel">
        {activeTab === 'overview' && (
