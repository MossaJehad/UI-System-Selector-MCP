...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-semantic" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-semantic" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-semantic ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-semantic ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-semantic ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-semantic" role="tabpanel">
        {activeTab === 'overview' && (
