...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-hubspot" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-hubspot" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-hubspot ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-hubspot ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-hubspot ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-hubspot" role="tabpanel">
        {activeTab === 'overview' && (
