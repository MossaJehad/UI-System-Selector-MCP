...
export const Pagination: React.FC = () => {
  ...
  return (
    <div className="ds-helsinki" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <nav className="ds-pagination-helsinki" aria-label="Pagination Navigation">
        <button
          type="button"
          className="ds-page-btn-helsinki"
        ...
        {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
          <button
            key={page}
            type="button"
            className={`ds-page-btn-helsinki ${currentPage === page ? 'active' : ''}`}
