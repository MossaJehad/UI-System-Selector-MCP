...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-helsinki" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-helsinki" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-helsinki ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-helsinki ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-helsinki ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-helsinki" role="tabpanel">
        {activeTab === 'overview' && (
