...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-bbc-gel" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-bbc-gel" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-bbc-gel ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-bbc-gel ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-bbc-gel ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-bbc-gel" role="tabpanel">
        {activeTab === 'overview' && (
