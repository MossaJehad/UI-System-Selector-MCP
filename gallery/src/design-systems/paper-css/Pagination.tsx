...
export const Pagination: React.FC = () => {
  ...
  return (
    <div className="ds-paper-css" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <nav className="ds-pagination-paper-css" aria-label="Pagination Navigation">
        <button
          type="button"
          className="ds-page-btn-paper-css"
        ...
        {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
          <button
            key={page}
            type="button"
            className={`ds-page-btn-paper-css ${currentPage === page ? 'active' : ''}`}
