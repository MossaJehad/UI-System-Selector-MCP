...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-paper-css" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-paper-css" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-paper-css ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-paper-css ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-paper-css ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-paper-css" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
