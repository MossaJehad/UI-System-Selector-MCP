...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-infor" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-infor" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-infor ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-infor ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-infor ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-infor" role="tabpanel">
        {activeTab === 'overview' && (
