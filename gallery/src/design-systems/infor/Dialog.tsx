  ...
  return (
    <div className="ds-infor">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-infor" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-infor"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-infor"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-infor">
            ...
            <div className="ds-dialog-body-infor">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-infor">
              <button
                type="button"
              ...
              <button
                type="button"
                className="ds-btn-infor ds-btn-infor-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
