...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-nasa-jpl" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-nasa-jpl" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-nasa-jpl ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-nasa-jpl ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-nasa-jpl ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-nasa-jpl" role="tabpanel">
        {activeTab === 'overview' && (
