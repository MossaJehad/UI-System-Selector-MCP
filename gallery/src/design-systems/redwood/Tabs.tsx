...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-redwood" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-redwood" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-redwood ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-redwood ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-redwood ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-redwood" role="tabpanel">
        {activeTab === 'overview' && (
