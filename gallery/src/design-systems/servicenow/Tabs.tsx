...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-servicenow" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-servicenow" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-servicenow ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-servicenow ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-servicenow ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-servicenow" role="tabpanel">
        {activeTab === 'overview' && (
