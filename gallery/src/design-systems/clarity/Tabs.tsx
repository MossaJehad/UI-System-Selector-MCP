...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-clarity" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-clarity" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-clarity ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-clarity ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-clarity ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-clarity" role="tabpanel">
        {activeTab === 'overview' && (
