...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-uniform" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-uniform" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-uniform ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-uniform ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-uniform ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-uniform" role="tabpanel">
        {activeTab === 'overview' && (
