...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-fluent" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-fluent" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-fluent ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-fluent ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-fluent ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-fluent" role="tabpanel">
        {activeTab === 'overview' && (
