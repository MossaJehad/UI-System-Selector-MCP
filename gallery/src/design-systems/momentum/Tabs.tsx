...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-momentum" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-momentum" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-momentum ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-momentum ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-momentum ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-momentum" role="tabpanel">
        {activeTab === 'overview' && (
