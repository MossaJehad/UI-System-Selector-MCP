...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-ontario" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-ontario" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-ontario ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-ontario ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-ontario ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-ontario" role="tabpanel">
        {activeTab === 'overview' && (
