...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-psone-css" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-psone-css" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-psone-css ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-psone-css ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-psone-css ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-psone-css" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
