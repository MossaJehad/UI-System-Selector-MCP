...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-priceline-one" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-priceline-one" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-priceline-one ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-priceline-one ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-priceline-one ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-priceline-one" role="tabpanel">
        {activeTab === 'overview' && (
