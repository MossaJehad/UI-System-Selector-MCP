...
export const Toast: React.FC = () => {
  ...
  return (
    <div className="ds-blueprint" style={{ padding: '8px 0', minHeight: '80px', position: 'relative' }}>
      ...
      {toastOpen && (
        ...
        >
          <span className="ds-toast-content-blueprint">
            ✓ Settings saved successfully. Node #{counter} configuration synchronized.
          </span>
          <button
            type="button"
            className="ds-toast-close-blueprint"
