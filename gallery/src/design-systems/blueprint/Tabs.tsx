...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-blueprint" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-blueprint" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-blueprint ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-blueprint ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-blueprint ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-blueprint" role="tabpanel">
        {activeTab === 'overview' && (
