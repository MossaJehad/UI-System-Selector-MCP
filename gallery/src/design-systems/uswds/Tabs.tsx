...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-uswds" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-uswds" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-uswds ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-uswds ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-uswds ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-uswds" role="tabpanel">
        {activeTab === 'overview' && (
