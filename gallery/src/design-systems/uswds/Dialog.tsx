  ...
  return (
    <div className="ds-uswds">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-uswds" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-uswds"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-uswds"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-uswds">
            ...
            <div className="ds-dialog-body-uswds">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-uswds">
              <button
                type="button"
                className="ds-btn-uswds ds-btn-uswds-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-uswds ds-btn-uswds-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
