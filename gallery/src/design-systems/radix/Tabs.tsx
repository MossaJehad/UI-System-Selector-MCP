...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-radix" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-radix" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-radix ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-radix ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-radix ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-radix" role="tabpanel">
        {activeTab === 'overview' && (
