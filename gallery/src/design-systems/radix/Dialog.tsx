  ...
  return (
    <div className="ds-radix">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-radix" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-radix"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-radix"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-radix">
            ...
            <div className="ds-dialog-body-radix">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-radix">
              <button
                type="button"
                className="ds-btn-radix ds-btn-radix-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-radix ds-btn-radix-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
