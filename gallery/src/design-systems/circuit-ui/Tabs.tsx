...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-circuit-ui" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-circuit-ui" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-circuit-ui ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-circuit-ui ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-circuit-ui ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-circuit-ui" role="tabpanel">
        {activeTab === 'overview' && (
