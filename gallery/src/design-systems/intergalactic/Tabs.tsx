...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-intergalactic" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-intergalactic" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-intergalactic ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-intergalactic ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-intergalactic ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-intergalactic" role="tabpanel">
        {activeTab === 'overview' && (
