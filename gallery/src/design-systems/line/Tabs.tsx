...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-line" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-line" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-line ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-line ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-line ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-line" role="tabpanel">
        {activeTab === 'overview' && (
