...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-salesforce" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-salesforce" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-salesforce ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-salesforce ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-salesforce ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-salesforce" role="tabpanel">
        {activeTab === 'overview' && (
