...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-geist" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-geist" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-geist ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-geist ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-geist ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-geist" role="tabpanel">
        {activeTab === 'overview' && (
