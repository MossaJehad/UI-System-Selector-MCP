  ...
  return (
    <div className="ds-geist">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-geist" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-geist"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-geist"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-geist">
            ...
            <div className="ds-dialog-body-geist">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-geist">
              <button
                type="button"
                className="ds-btn-geist ds-btn-geist-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-geist ds-btn-geist-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
