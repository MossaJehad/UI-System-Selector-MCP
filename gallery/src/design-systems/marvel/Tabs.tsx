...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-marvel" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-marvel" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-marvel ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-marvel ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-marvel ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-marvel" role="tabpanel">
        {activeTab === 'overview' && (
