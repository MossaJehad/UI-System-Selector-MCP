...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-audi" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-audi" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-audi ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-audi ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-audi ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-audi" role="tabpanel">
        {activeTab === 'overview' && (
