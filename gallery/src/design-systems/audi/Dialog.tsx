  ...
  return (
    <div className="ds-audi">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-audi" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-audi"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-audi"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-audi">
            ...
            <div className="ds-dialog-body-audi">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-audi">
              <button
                type="button"
                className="ds-btn-audi ds-btn-audi-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-audi ds-btn-audi-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
