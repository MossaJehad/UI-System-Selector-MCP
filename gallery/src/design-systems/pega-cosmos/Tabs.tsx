...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-pega-cosmos" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-pega-cosmos" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-pega-cosmos ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-pega-cosmos ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-pega-cosmos ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-pega-cosmos" role="tabpanel">
        {activeTab === 'overview' && (
