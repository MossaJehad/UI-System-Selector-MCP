...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-thumbprint" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-thumbprint" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-thumbprint ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-thumbprint ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-thumbprint ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-thumbprint" role="tabpanel">
        {activeTab === 'overview' && (
