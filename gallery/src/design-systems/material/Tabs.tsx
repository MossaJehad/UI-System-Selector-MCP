...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-material" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-material" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-material ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-material ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-material ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-material" role="tabpanel">
        {activeTab === 'overview' && (
