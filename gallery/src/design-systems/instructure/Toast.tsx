...
export const Toast: React.FC = () => {
  ...
  return (
    <div className="ds-instructure" style={{ padding: '8px 0', minHeight: '80px', position: 'relative' }}>
      ...
      {toastOpen && (
        <div
          className="ds-toast-instructure"
          role="status"
          aria-live="polite"
          style={{
            marginTop: '12px',
        ...
        >
          <span className="ds-toast-content-instructure">
            ✓ Settings saved successfully. Node #{counter} configuration synchronized.
          </span>
          <button
            type="button"
            className="ds-toast-close-instructure"
