...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-instructure" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-instructure" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-instructure ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-instructure ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-instructure ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-instructure" role="tabpanel">
        {activeTab === 'overview' && (
