...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-rhds" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-rhds" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-rhds ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-rhds ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-rhds ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-rhds" role="tabpanel">
        {activeTab === 'overview' && (
