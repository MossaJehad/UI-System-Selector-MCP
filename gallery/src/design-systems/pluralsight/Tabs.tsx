...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-pluralsight" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-pluralsight" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-pluralsight ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-pluralsight ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-pluralsight ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-pluralsight" role="tabpanel">
        {activeTab === 'overview' && (
