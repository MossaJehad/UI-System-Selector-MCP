...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-nachos" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-nachos" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-nachos ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-nachos ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-nachos ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-nachos" role="tabpanel">
        {activeTab === 'overview' && (
