  ...
  return (
    <div className="ds-uae">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-uae" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-uae"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-uae"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-uae">
            ...
            <div className="ds-dialog-body-uae">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-uae">
              <button
                type="button"
              ...
              <button
                type="button"
                className="ds-btn-uae ds-btn-uae-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
