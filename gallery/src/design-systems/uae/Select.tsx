...
export const Select: React.FC = () => {
  ...
  return (
    <div className="ds-uae" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' }}>
      <div>
        <label className="ds-label-uae">Select Region (Interactive)</label>
        <select
          className="ds-select-uae"
          value={selected}
        ...
        <span className="ds-helper-uae">Active choice: <strong>{selected}</strong></span>
      </div>

      <div>
        <label className="ds-label-uae">Selected Tier</label>
        <select className="ds-select-uae" defaultValue="enterprise">
        ...
        <span className="ds-helper-uae">Includes 24/7 SLA & priority routing</span>
      </div>

      <div>
        <label className="ds-label-uae">Error State</label>
        <select className="ds-select-uae error" defaultValue="">
        ...
        <span className="ds-error-text-uae">You must select an isolated VPC</span>
      </div>

      <div>
        <label className="ds-label-uae">Disabled Select</label>
        <select className="ds-select-uae" defaultValue="locked" disabled>
          <option value="locked">Production Environment (Locked)</option>
          <option value="staging">Staging</option>
        </select>
        <span className="ds-helper-uae">Locked by compliance policy</span>
      </div>
    </div>
  );
};
