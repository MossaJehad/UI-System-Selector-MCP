...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-uae" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-uae" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-uae ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-uae ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-uae ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-uae" role="tabpanel">
        {activeTab === 'overview' && (
