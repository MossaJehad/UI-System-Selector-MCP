  ...
  return (
    <div className="ds-garden">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-garden" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-garden"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-garden"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-garden">
            ...
            <div className="ds-dialog-body-garden">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-garden">
              <button
                type="button"
              ...
              <button
                type="button"
                className="ds-btn-garden ds-btn-garden-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
