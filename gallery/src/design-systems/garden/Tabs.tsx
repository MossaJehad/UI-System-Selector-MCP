...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-garden" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-garden" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-garden ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-garden ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-garden ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-garden" role="tabpanel">
        {activeTab === 'overview' && (
