...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-mixpanel" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-mixpanel" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-mixpanel ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-mixpanel ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-mixpanel ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-mixpanel" role="tabpanel">
        {activeTab === 'overview' && (
