...
export const Toast: React.FC = () => {
  ...
  return (
    <div className="ds-warcraftcn-ui" style={{ padding: '8px 0', minHeight: '80px', position: 'relative' }}>
      ...
      {toastOpen && (
        <div
          className="ds-toast-warcraftcn-ui"
          role="status"
          aria-live="polite"
          style={{
            marginTop: '12px',
        ...
        >
          <span className="ds-toast-content-warcraftcn-ui">
            ✓ Settings saved successfully. Node #{counter} configuration synchronized.
          </span>
          <button
            type="button"
            className="ds-toast-close-warcraftcn-ui"
