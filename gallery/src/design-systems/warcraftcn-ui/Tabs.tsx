...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-warcraftcn-ui" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-warcraftcn-ui" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-warcraftcn-ui ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-warcraftcn-ui ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-warcraftcn-ui ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-warcraftcn-ui" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
