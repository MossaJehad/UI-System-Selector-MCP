...
export const Radio: React.FC = () => {
  ...
  return (
    <div className="ds-warcraftcn-ui" style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
      <label className="ds-label-warcraftcn-ui">Deployment Tier</label>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
        <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', fontSize: '14px' }}>
          <input
            type="radio"
            name="tier-warcraftcn-ui"
            className="ds-radio-warcraftcn-ui"
