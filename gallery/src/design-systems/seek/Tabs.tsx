...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-seek" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-seek" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-seek ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-seek ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-seek ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-seek" role="tabpanel">
        {activeTab === 'overview' && (
