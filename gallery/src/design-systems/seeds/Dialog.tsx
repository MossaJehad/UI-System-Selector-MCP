  ...
  return (
    <div className="ds-seeds">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-seeds" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-seeds"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-seeds"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-seeds">
            ...
            <div className="ds-dialog-body-seeds">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-seeds">
              <button
                type="button"
                className="ds-btn-seeds ds-btn-seeds-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-seeds ds-btn-seeds-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
