...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-seeds" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-seeds" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-seeds ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-seeds ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-seeds ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-seeds" role="tabpanel">
        {activeTab === 'overview' && (
