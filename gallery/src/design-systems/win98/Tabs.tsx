...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-win98" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-win98" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-win98 ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-win98 ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-win98 ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-win98" role="tabpanel">
        {activeTab === 'overview' && (
