...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-ant" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-ant" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-ant ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-ant ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-ant ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-ant" role="tabpanel">
        {activeTab === 'overview' && (
