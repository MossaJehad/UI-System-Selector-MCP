...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-fiori" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-fiori" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-fiori ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-fiori ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-fiori ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-fiori" role="tabpanel">
        {activeTab === 'overview' && (
