...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-terminal-css" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-terminal-css" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-terminal-css ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-terminal-css ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-terminal-css ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-terminal-css" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
