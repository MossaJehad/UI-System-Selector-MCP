...
export const Select: React.FC = () => {
  ...
  return (
    <div className="ds-axa" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' }}>
      <div>
        <label className="ds-label-axa">Select Region (Interactive)</label>
        <select
          className="ds-select-axa"
          value={selected}
        ...
        <span className="ds-helper-axa">Active choice: <strong>{selected}</strong></span>
      </div>

      <div>
        <label className="ds-label-axa">Selected Tier</label>
        <select className="ds-select-axa" defaultValue="enterprise">
        ...
        <span className="ds-helper-axa">Includes 24/7 SLA & priority routing</span>
      </div>

      <div>
        <label className="ds-label-axa">Error State</label>
        <select className="ds-select-axa error" defaultValue="">
        ...
        <span className="ds-error-text-axa">You must select an isolated VPC</span>
      </div>

      <div>
        <label className="ds-label-axa">Disabled Select</label>
        <select className="ds-select-axa" defaultValue="locked" disabled>
          <option value="locked">Production Environment (Locked)</option>
          <option value="staging">Staging</option>
        </select>
        <span className="ds-helper-axa">Locked by compliance policy</span>
      </div>
    </div>
  );
};
