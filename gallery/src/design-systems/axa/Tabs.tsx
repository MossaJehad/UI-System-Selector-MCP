...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-axa" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-axa" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-axa ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-axa ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-axa ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-axa" role="tabpanel">
        {activeTab === 'overview' && (
