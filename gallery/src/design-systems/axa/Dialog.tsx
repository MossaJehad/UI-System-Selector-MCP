  ...
  return (
    <div className="ds-axa">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-axa" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-axa"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-axa"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-axa">
            ...
            <div className="ds-dialog-body-axa">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-axa">
              <button
                type="button"
                className="ds-btn-axa ds-btn-axa-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-axa ds-btn-axa-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
