  ...
  return (
    <div className="ds-daisyui">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-daisyui" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-daisyui"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-daisyui"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-daisyui">
            ...
            <div className="ds-dialog-body-daisyui">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-daisyui">
              <button
                type="button"
                className="ds-btn-daisyui ds-btn-daisyui-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-daisyui ds-btn-daisyui-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
