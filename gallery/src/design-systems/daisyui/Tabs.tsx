...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-daisyui" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-daisyui" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-daisyui ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-daisyui ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-daisyui ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-daisyui" role="tabpanel">
        {activeTab === 'overview' && (
