...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-rivet" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-rivet" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-rivet ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-rivet ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-rivet ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-rivet" role="tabpanel">
        {activeTab === 'overview' && (
