...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-kaizen" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-kaizen" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-kaizen ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-kaizen ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-kaizen ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-kaizen" role="tabpanel">
        {activeTab === 'overview' && (
