...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-helios" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-helios" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-helios ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-helios ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-helios ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-helios" role="tabpanel">
        {activeTab === 'overview' && (
