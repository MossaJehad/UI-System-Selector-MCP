...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-tractie" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-tractie" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-tractie ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-tractie ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-tractie ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-tractie" role="tabpanel">
        {activeTab === 'overview' && (
