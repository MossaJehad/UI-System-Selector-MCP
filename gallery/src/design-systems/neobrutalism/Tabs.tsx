...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-neobrutalism" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-neobrutalism" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-neobrutalism ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-neobrutalism ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-neobrutalism ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-neobrutalism" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
