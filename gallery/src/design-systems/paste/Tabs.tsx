...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-paste" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-paste" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-paste ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-paste ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-paste ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-paste" role="tabpanel">
        {activeTab === 'overview' && (
