...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-pega-bolt" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-pega-bolt" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-pega-bolt ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-pega-bolt ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-pega-bolt ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-pega-bolt" role="tabpanel">
        {activeTab === 'overview' && (
