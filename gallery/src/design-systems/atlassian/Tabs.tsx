...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-atlassian" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-atlassian" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-atlassian ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-atlassian ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-atlassian ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-atlassian" role="tabpanel">
        {activeTab === 'overview' && (
