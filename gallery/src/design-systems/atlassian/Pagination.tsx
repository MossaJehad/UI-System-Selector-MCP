...
export const Pagination: React.FC = () => {
  ...
  return (
    <div className="ds-atlassian" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <nav className="ds-pagination-atlassian" aria-label="Pagination Navigation">
        <button
          type="button"
          className="ds-page-btn-atlassian"
        ...
        {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
          <button
            key={page}
            type="button"
            className={`ds-page-btn-atlassian ${currentPage === page ? 'active' : ''}`}
