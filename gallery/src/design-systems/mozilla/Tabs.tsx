...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-mozilla" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-mozilla" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-mozilla ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-mozilla ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-mozilla ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-mozilla" role="tabpanel">
        {activeTab === 'overview' && (
