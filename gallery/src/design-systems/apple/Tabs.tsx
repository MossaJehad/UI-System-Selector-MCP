...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-apple" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-apple" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-apple ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-apple ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-apple ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-apple" role="tabpanel">
        {activeTab === 'overview' && (
