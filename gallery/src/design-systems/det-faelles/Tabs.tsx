...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-det-faelles" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-det-faelles" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-det-faelles ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-det-faelles ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-det-faelles ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-det-faelles" role="tabpanel">
        {activeTab === 'overview' && (
