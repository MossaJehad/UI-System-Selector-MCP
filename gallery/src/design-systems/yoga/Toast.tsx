...
export const Toast: React.FC = () => {
  ...
  return (
    <div className="ds-yoga" style={{ padding: '8px 0', minHeight: '80px', position: 'relative' }}>
