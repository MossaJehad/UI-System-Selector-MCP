...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-yoga" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-yoga" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-yoga ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-yoga ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-yoga ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-yoga" role="tabpanel">
        {activeTab === 'overview' && (
