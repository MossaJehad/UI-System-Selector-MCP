...
export const Pagination: React.FC = () => {
  ...
  return (
    <div className="ds-arui-feather" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <nav className="ds-pagination-arui-feather" aria-label="Pagination Navigation">
        <button
          type="button"
          className="ds-page-btn-arui-feather"
        ...
        {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
          <button
            key={page}
            type="button"
            className={`ds-page-btn-arui-feather ${currentPage === page ? 'active' : ''}`}
