...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-arui-feather" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-arui-feather" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-arui-feather ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-arui-feather ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-arui-feather ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-arui-feather" role="tabpanel">
        {activeTab === 'overview' && (
