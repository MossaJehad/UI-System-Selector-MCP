...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-carbon" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-carbon" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-carbon ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-carbon ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-carbon ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-carbon" role="tabpanel">
        {activeTab === 'overview' && (
