...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-acorn" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-acorn" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-acorn ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-acorn ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-acorn ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-acorn" role="tabpanel">
        {activeTab === 'overview' && (
