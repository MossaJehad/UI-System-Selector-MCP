...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-shadcn" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-shadcn" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-shadcn ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-shadcn ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-shadcn ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-shadcn" role="tabpanel">
        {activeTab === 'overview' && (
