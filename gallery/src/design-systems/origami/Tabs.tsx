...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-origami" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-origami" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-origami ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-origami ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-origami ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-origami" role="tabpanel">
        {activeTab === 'overview' && (
