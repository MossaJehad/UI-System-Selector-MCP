...
export const Pagination: React.FC = () => {
  ...
  return (
    <div className="ds-office-fabric" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <nav className="ds-pagination-office-fabric" aria-label="Pagination Navigation">
        <button
          type="button"
          className="ds-page-btn-office-fabric"
        ...
        {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
          <button
            key={page}
            type="button"
            className={`ds-page-btn-office-fabric ${currentPage === page ? 'active' : ''}`}
