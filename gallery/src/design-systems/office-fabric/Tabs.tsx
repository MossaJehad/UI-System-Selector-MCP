...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-office-fabric" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-office-fabric" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-office-fabric ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-office-fabric ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-office-fabric ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-office-fabric" role="tabpanel">
        {activeTab === 'overview' && (
