...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-nes-css" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-nes-css" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-nes-css ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-nes-css ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-nes-css ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-nes-css" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
