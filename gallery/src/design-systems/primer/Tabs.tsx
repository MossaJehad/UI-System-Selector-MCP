...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-primer" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-primer" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-primer ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-primer ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-primer ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-primer" role="tabpanel">
        {activeTab === 'overview' && (
