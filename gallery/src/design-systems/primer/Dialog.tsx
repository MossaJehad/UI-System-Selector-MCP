  ...
  return (
    <div className="ds-primer">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-primer" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-primer"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-primer"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-primer">
            ...
            <div className="ds-dialog-body-primer">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-primer">
              <button
                type="button"
              ...
              <button
                type="button"
                className="ds-btn-primer ds-btn-primer-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
