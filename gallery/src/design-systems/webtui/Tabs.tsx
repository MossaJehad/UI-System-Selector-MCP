...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-webtui" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-webtui" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-webtui ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-webtui ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-webtui ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-webtui" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
