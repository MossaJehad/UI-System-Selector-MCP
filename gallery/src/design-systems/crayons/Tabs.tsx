...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-crayons" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-crayons" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-crayons ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-crayons ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-crayons ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-crayons" role="tabpanel">
        {activeTab === 'overview' && (
