...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-italia" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-italia" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-italia ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-italia ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-italia ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-italia" role="tabpanel">
        {activeTab === 'overview' && (
