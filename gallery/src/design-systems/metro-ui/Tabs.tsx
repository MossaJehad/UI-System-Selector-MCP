...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-metro-ui" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-metro-ui" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-metro-ui ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-metro-ui ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-metro-ui ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-metro-ui" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
