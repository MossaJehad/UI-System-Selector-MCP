...
export const Toast: React.FC = () => {
  ...
  return (
    <div className="ds-metro-ui" style={{ padding: '8px 0', minHeight: '80px', position: 'relative' }}>
      ...
      {toastOpen && (
        ...
        >
          <span className="ds-toast-content-metro-ui">
            ✓ Settings saved successfully. Node #{counter} configuration synchronized.
          </span>
          <button
            type="button"
            className="ds-toast-close-metro-ui"
