...
export const Pagination: React.FC = () => {
  ...
  return (
    <div className="ds-forma-36" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <nav className="ds-pagination-forma-36" aria-label="Pagination Navigation">
        <button
          type="button"
          className="ds-page-btn-forma-36"
        ...
        {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
          <button
            key={page}
            type="button"
            className={`ds-page-btn-forma-36 ${currentPage === page ? 'active' : ''}`}
