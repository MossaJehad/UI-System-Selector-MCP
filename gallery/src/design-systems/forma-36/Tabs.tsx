...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-forma-36" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-forma-36" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-forma-36 ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-forma-36 ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-forma-36 ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-forma-36" role="tabpanel">
        {activeTab === 'overview' && (
