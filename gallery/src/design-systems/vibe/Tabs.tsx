...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-vibe" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-vibe" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-vibe ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-vibe ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-vibe ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-vibe" role="tabpanel">
        {activeTab === 'overview' && (
