...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-vtex" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-vtex" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-vtex ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-vtex ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-vtex ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-vtex" role="tabpanel">
        {activeTab === 'overview' && (
