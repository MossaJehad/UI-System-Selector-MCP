...
export const Toast: React.FC = () => {
  ...
  return (
    <div className="ds-vtex" style={{ padding: '8px 0', minHeight: '80px', position: 'relative' }}>
