  ...
  return (
    <div className="ds-vtex">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-vtex" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-vtex"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-vtex"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-vtex">
            ...
            <div className="ds-dialog-body-vtex">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-vtex">
              <button
                type="button"
                className="ds-btn-vtex ds-btn-vtex-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-vtex ds-btn-vtex-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
