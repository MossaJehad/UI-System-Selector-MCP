...
export const Select: React.FC = () => {
  ...
  return (
    <div className="ds-nhs" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' }}>
      <div>
        <label className="ds-label-nhs">Select Region (Interactive)</label>
        <select
          className="ds-select-nhs"
          value={selected}
        ...
        <span className="ds-helper-nhs">Active choice: <strong>{selected}</strong></span>
      </div>

      <div>
        <label className="ds-label-nhs">Selected Tier</label>
        <select className="ds-select-nhs" defaultValue="enterprise">
        ...
        <span className="ds-helper-nhs">Includes 24/7 SLA & priority routing</span>
      </div>

      <div>
        <label className="ds-label-nhs">Error State</label>
        <select className="ds-select-nhs error" defaultValue="">
        ...
        <span className="ds-error-text-nhs">You must select an isolated VPC</span>
      </div>

      <div>
        <label className="ds-label-nhs">Disabled Select</label>
        <select className="ds-select-nhs" defaultValue="locked" disabled>
          <option value="locked">Production Environment (Locked)</option>
          <option value="staging">Staging</option>
        </select>
        <span className="ds-helper-nhs">Locked by compliance policy</span>
      </div>
    </div>
  );
};
