...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-nhs" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-nhs" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-nhs ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-nhs ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-nhs ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-nhs" role="tabpanel">
        {activeTab === 'overview' && (
