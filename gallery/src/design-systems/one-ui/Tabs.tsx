...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-one-ui" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-one-ui" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-one-ui ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-one-ui ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-one-ui ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-one-ui" role="tabpanel">
        {activeTab === 'overview' && (
