  ...
  return (
    <div className="ds-dsfr">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-dsfr" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-dsfr"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-dsfr"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-dsfr">
            ...
            <div className="ds-dialog-body-dsfr">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-dsfr">
              <button
                type="button"
                className="ds-btn-dsfr ds-btn-dsfr-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-dsfr ds-btn-dsfr-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
