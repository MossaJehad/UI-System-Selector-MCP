...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-dsfr" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-dsfr" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-dsfr ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-dsfr ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-dsfr ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-dsfr" role="tabpanel">
        {activeTab === 'overview' && (
