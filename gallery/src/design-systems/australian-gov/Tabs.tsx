...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-australian-gov" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-australian-gov" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-australian-gov ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-australian-gov ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-australian-gov ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-australian-gov" role="tabpanel">
        {activeTab === 'overview' && (
