...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-patternfly" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-patternfly" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-patternfly ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-patternfly ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-patternfly ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-patternfly" role="tabpanel">
        {activeTab === 'overview' && (
