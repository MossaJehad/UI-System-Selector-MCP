...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-rpgui" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div className="ds-tablist-rpgui" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          className={`ds-tab-rpgui ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-rpgui ${activeTab === 'metrics' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-rpgui ${activeTab === 'security' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-rpgui" role="tabpanel">
        {activeTab === 'overview' && (
          <div>
