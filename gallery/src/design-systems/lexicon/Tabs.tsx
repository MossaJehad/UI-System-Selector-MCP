...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-lexicon" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-lexicon" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-lexicon ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-lexicon ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-lexicon ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-lexicon" role="tabpanel">
        {activeTab === 'overview' && (
