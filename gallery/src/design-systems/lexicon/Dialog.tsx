  ...
  return (
    <div className="ds-lexicon">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <span className="ds-helper-lexicon" style={{ marginTop: 0 }}>
      ...
      {isOpen && (
        <div
          className="ds-dialog-overlay-lexicon"
          role="dialog"
          aria-modal="true"
          onClick={() => setIsOpen(false)}
        >
          <div
            className="ds-dialog-box-lexicon"
            onClick={e => e.stopPropagation()}
          >
            <div className="ds-dialog-header-lexicon">
            ...
            <div className="ds-dialog-body-lexicon">
              <p style={{ margin: 0 }}>
            ...
            <div className="ds-dialog-footer-lexicon">
              <button
                type="button"
                className="ds-btn-lexicon ds-btn-lexicon-secondary"
                onClick={() => setIsOpen(false)}
              >
                Cancel
              </button>
              <button
                type="button"
                className="ds-btn-lexicon ds-btn-lexicon-danger"
                onClick={() => setIsOpen(false)}
              >
                Delete Cluster
              </button>
