...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-nys" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-nys" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-nys ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-nys ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-nys ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-nys" role="tabpanel">
        {activeTab === 'overview' && (
