...
export const Select: React.FC = () => {
  ...
  return (
    <div className="ds-nys" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' }}>
      <div>
        <label className="ds-label-nys">Select Region (Interactive)</label>
        <select
          className="ds-select-nys"
          value={selected}
        ...
        <span className="ds-helper-nys">Active choice: <strong>{selected}</strong></span>
      </div>

      <div>
        <label className="ds-label-nys">Selected Tier</label>
        <select className="ds-select-nys" defaultValue="enterprise">
        ...
        <span className="ds-helper-nys">Includes 24/7 SLA & priority routing</span>
      </div>

      <div>
        <label className="ds-label-nys">Error State</label>
        <select className="ds-select-nys error" defaultValue="">
        ...
        <span className="ds-error-text-nys">You must select an isolated VPC</span>
      </div>

      <div>
        <label className="ds-label-nys">Disabled Select</label>
        <select className="ds-select-nys" defaultValue="locked" disabled>
          <option value="locked">Production Environment (Locked)</option>
          <option value="staging">Staging</option>
        </select>
        <span className="ds-helper-nys">Locked by compliance policy</span>
      </div>
    </div>
  );
};
