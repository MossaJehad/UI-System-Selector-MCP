...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-base-web" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-base-web" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-base-web ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-base-web ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-base-web ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-base-web" role="tabpanel">
        {activeTab === 'overview' && (
