...
export const Toast: React.FC = () => {
  ...
  return (
    <div className="ds-base-web" style={{ padding: '8px 0', minHeight: '80px', position: 'relative' }}>
      ...
      {toastOpen && (
        ...
        >
          <span className="ds-toast-content-base-web">
            ✓ Settings saved successfully. Node #{counter} configuration synchronized.
          </span>
          <button
            type="button"
            className="ds-toast-close-base-web"
