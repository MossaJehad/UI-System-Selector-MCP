...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-cedar" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-cedar" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-cedar ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-cedar ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-cedar ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-cedar" role="tabpanel">
        {activeTab === 'overview' && (
