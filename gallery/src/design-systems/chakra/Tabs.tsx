...
export const Tabs: React.FC = () => {
  ...
  return (
    <div className="ds-chakra" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div className="ds-tablist-chakra" role="tablist" aria-label="System details">
        <button
          type="button"
          role="tab"
          aria-selected={activeTab === 'overview'}
          tabIndex={activeTab === 'overview' ? 0 : -1}
          className={`ds-tab-chakra ${activeTab === 'overview' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-chakra ${activeTab === 'settings' ? 'active' : ''}`}
        ...
        <button
          ...
          className={`ds-tab-chakra ${activeTab === 'activity' ? 'active' : ''}`}
      ...
      <div className="ds-tabpanel-chakra" role="tabpanel">
        {activeTab === 'overview' && (
